...
Then Plot RMSE vs K graphs to find the K which gives the minimum RMSE for both models
```{r}
...
From the graphs the optimal K value is 13 for 350 trim and 7 for 65 AMG trim.
